...
export const navLinks = [
  ...
  },
  {
    ...
    title: "Resume",
    external_link:
      "https://drive.google.com/file/d/1jHIRdEJC3LRA5Tz9S9439uhRDJsfiQCd/view?usp=sharing",
  },
];
...
export const experiences = [
  {
    ...
    companyName: "Enterprise minds",
    icon: eminds,
    date: "Aug 2023 - Present",
    points: [
      "Spearheaded the integration of quicksort and merge sort algorithms in NodeJS, reducing query processing time by 50% and boosting system efficiency.",
      "Designed and developed scalable APIs in NodeJS, improving system performance and response times.",
      "Collaborated with production teams to design and enhance single-page web applications using HTML5, CSS3, JavaScript.",
      "Implemented NodeJS-based backend architecture, improving system scalability and responsiveness for high-traffic applications.",
      "Integrated NodeJS with MongoDB to optimize data management, enhancing database interactions and overall performance.",
      "Utilized NodeJS and Express for server-side scripting, enhancing the functionality of web applications with minimal latency.",
      "Collaborated with teams to build interactive single-page applications using NodeJS and React, leading to faster load times.",
      "Refined error-handling mechanisms in NodeJS applications, improving reliability and reducing downtime.",
    ],
  },
  {
    title: "Research Student",
    companyName: "Saveetha Institute",
    icon: SSE,
...
export const education = [
  ...
  },
  {
    ...
    companyName: "Saveetha Institute of Medical and Technical Sciences",
    icon: SSE,
