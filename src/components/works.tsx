    ...
    <>
      ...
      <div className="flex w-full">
        <motion.p
          ...
          className="section-text pointer-events-auto mt-3 max-w-3xl text-[17px] leading-[30px] text-text"
        >
          As a software engineer, I have a holistic understanding of
          applications and the data that influences them. I am really interested
          in working on real-world projects that have a meaningful impact on
          people&apos;s lives. Due to this background, I have a collection of
          projects that effectively demonstrate my skills and experience,
          showcasing real-world examples of my work. Some projects have
          demonstration links as well as repositories containing the source
          code. These projects serve as a testament to my proficiency in
          tackling different challenges, adeptness with diverse technologies,
